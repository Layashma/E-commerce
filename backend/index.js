...
//API creation
app.get("/",(req,res)=>{
  res.send("Hello Express App is Running in ecommerce-mern project")
})
...
app.get('/popularinwomen',async (req,res)=>{
    ...
    let popular_in_women=products.slice(0,11);
...
app.post('/addtocart',fetchUser,async (req,res)=>{
  console.log('Addeed',req.body.itemId);
...
//creating API end point to remove item from cartdata
...
//creating API end point to reteive cartdata (bcoz it will be lost always) when we login
